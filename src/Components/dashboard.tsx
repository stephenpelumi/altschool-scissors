...
function BurgerMenu() {
  ...
  return (
    <div className="burger-menu-container">
      <button className="js-fh5co-nav-toggle" onClick={toggleNav}>{isNavVisible ? 'Close Menu' : 'Open Menu'}</button>
      <nav className={`ftco-nav ${isNavVisible ? 'active' : ''}`}>
          ...
          <article>
            <div className="questioning_section">
              ...
              <div className="FAQ_vectors">
                ...
                <img
                  className="FAQ_vector_three"
                  src={FAQ_vector_three}
                  alt=""
                />
              </div>
            </div>
          ...
          <article>
            <section className="whole_revolution">
              ...
              <div className="lower_vector_revolution">
                <img
                  className="uppervector_four"
                  src={uppervector_four}
                  alt=""
                />
                <img
                  className="uppervector_five"
                  src={uppervector_five}
                  alt=""
                />
